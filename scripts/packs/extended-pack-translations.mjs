/**
 * Complete base UI translations (keys 1–186) for regional locales.
 * Tail keys 187–225 come from tail-supplement.json.
 */
...
export const guPack186 = {
  ...
  familyRitualReminders: "કુટુંબીય વિધિ સ्मારક",
  ...
  footerDisclaimer: "શૈક્ષણિક ભક્તિ સામગ્રી · મુહૂર્ત અને औपचारિક સંસ્કાર યોગ્ય પ્રાદેશિક સ્રોતથી ચકાસો.",
